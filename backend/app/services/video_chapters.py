...
from app.ai.model_roles import CHAPTERS, resolved_model_id
...
async def replace_with_semantic_chapters(
    *,
    ...
    # Record the model the chapterizer actually ran on (the CHAPTERS tier,
    # including its missing-key fallback) — not the global provider.
    model_id = resolved_model_id(settings, CHAPTERS)
